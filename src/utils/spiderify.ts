 ...
 * @param baseRadius Radius in degrees (approx). Default 0.00125 (~125m, doubled from previous increase)
 */
export const getSpiderOffsets = (count: number, baseRadius: number = 0.00125): number[][] => {
    if (count <= 1) return [];
