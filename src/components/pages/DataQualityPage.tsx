    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-gray-600">Cargando datos de calidad...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Error al cargar datos de calidad</h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Calidad de Datos</h2>
        <p className="text-gray-600">
          Análisis detallado de la calidad e integridad de los datos electorales
        </p>
      </div>
